...
remove_words = ['단독','이미지']
okt_news_list = crawling.process(CrawType.Okt, NewsType.DongA, node1, remove_words)
kma_news_list = crawling.process(CrawType.Kkma, NewsType.DongA, node1, remove_words)
han_news_list = crawling.process(CrawType.Hannan, NewsType.DongA, node1, remove_words)
kom_news_list = crawling.process(CrawType.Komor, NewsType.DongA, node1, remove_words)
